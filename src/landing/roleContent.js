...
export const ROLE_CONTENT = {
  tenant: {
    ...
    proofCards: {
      ...
      cards: [
        { avatar: 14, role: 'Landlord · Hackney', chips: ['ID verified', 'No agency fees'] },
        { avatar: 71, role: 'Agent · E8', chips: ['Redress member', 'Replies fast'] },
        { avatar: 33, role: 'Landlord · Bow', chips: ['Pet friendly', 'Reviews on file'] },
      ],
    },
  ...
  landlord: {
    ...
    proofCards: {
      ...
      cards: [
        { avatar: 7, role: 'Tenant · £2,000 budget', chips: ['Move-ready', 'References added'] },
        { avatar: 24, role: 'Tenants · £2,400 budget', chips: ['Income verified', 'Long-term'] },
        { avatar: 49, role: 'Tenant · £1,650 budget', chips: ['ID verified', 'No pets'] },
      ],
    },
  ...
  investor: {
    ...
    proofCards: {
      ...
      cards: [
        { avatar: 9, role: 'Sourcer · East London', chips: ['Companies House', 'Redress + AML'] },
        { avatar: 38, role: 'Operator · HMO', chips: ['Deals on record', 'ICO registered'] },
        { avatar: 62, role: 'Sourcer · BTL', chips: ['Track record public', 'ID verified'] },
      ],
    },
