...
export function MagicCard(props: MagicCardProps) {
  ...
  return (
    <motion.div
      className={cn(
        "group relative isolate overflow-hidden rounded-[inherit] border border-slate-200 border-transparent dark:border-slate-800",
        className
      )}
    ...
    >
      <div className="bg-white absolute inset-px z-20 rounded-[inherit] dark:bg-slate-950" />
